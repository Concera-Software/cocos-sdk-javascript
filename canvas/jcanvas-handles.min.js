...
function addRectHandle( $canvas, parent, px, py ) {
	...
	handle = $.extend( {
		...
		drag: function ( layer ) {
			...
			{
				parent.fontSize = parseInt(parent.fontSize + parseInt(layer.dy));
			}
...
function addHandles( parent ) {
	...
	if ( isRectLayer( parent )  || isTextLayer(parent)) {
...
$.extend( $.jCanvas.eventHooks, {
	...
	change: function ( layer, props ) {
		...
		if ( isRectLayer( layer ) || isTextLayer(layer) ) {
