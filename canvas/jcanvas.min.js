...
(function(g, U, J) {
    ...
    function Va(d, c, a) {
        var b, f, e, h;
        for (b in a)
            if (a.hasOwnProperty(b) && (f = a[b], da(f) && (a[b] = f.call(d, c, b)), "object" === aa(f) &&
                    Ga(f))) {
    ...
    function Ma(d, c, a, b) {
        ...
        for (void 0 !== b.x1 && void 0 !== b.y1 && c.moveTo(b.x1 + a.x, b.y1 + a.y);;)
            if (e =
                b["x" + f], h = b["y" + f], void 0 !== e && void 0 !== h) c.lineTo(e + a.x, h + a.y), f += 1;
            else break;
            --f;
    ...
    function Oa(d, c, a, b) {
        ...
        ga(d, c, a, b, b.cx1 + a.x, b.cy1 + a.y, b.x1 + a.x, b.y1 + a.y);
        for (void 0 !== b.x1 && void 0 !== b.y1 && c.moveTo(b.x1 + a.x, b.y1 + a.y);;)
            if (h = b["x" + f], g = b["y" + f], n = b["cx" + e], t = b["cy" + e], y = b["cx" + (e + 1)], E = b["cy" + (e + 1)], void 0 !== h && void 0 !== g && void 0 !== n && void 0 !== t && void 0 !== y && void 0 !== E) c.bezierCurveTo(n + a.x, t + a.y, y + a.x, E + a.y, h + a.x, g + a.y), f += 1, e += 2;
            else break;
            --f;
        e -= 2;
    ...
    function Ra(d, c, a, b) {
        ...
        for (void 0 !== b.x && void 0 !== b.y && c.moveTo(e, h);;)
            if (e = b["a" + f], h = b["l" + f], void 0 !== e && void 0 !== h) g = t, n = y, t += Pa(a, e, h), y += Qa(a, e, h), c.lineTo(t, y), f += 1;
            else break;
        ha(d, c, a, b, g, n, t, y)
    }
    ...
    g.fn.removeLayer = function(d) {
        ...
        for (a = 0; a < this.length; a += 1)
            if (c = g(this[a]), b = H(this[a]), f = c.getLayers(), e = c.getLayer(d)) e.index =
                ia(e, f), f.splice(e.index, 1), delete e._layer, pa(c, b, e, {
                    name: null
                }), qa(c, b, e, {
                    groups: null
                }), O(c, b, e, "remove");
        ...
        for (c = 0; c < this.length; c += 1)
            if (d = g(this[c]), a = K(this[c])) {
                ...
                for (h = M; h < a.length; h += 1)
                    if (f = a[h], f.index = h, b.resetFire && (f._fired = !1), t = d, y = f, e = h + 1, y && y.visible && y._method && (y._next = e ? e : null, y._method.call(t, y)), f._masks = n.transforms.masks.slice(0), f._method === g.fn.drawImage && f.visible) {
                        E = !0;
                        break
                    }
                if (E) break;
                ...
                if (n.drag.layer) {
                    ...
                    if ("mousemove" === C || "touchmove" === C) {
                        if (k.dragging || (k.dragging = !0, m.dragging = !0, m.bringToFront && (u.splice(m.index, 1), m.index = u.push(m)), m._startX = m.x, m._startY =
                                m.y, m._endX = m._eventX, m._endY = m._eventY, O(e, w, m, "dragstart")), k.dragging)
                            for (u = m._eventX - (m._endX - m._startX), k = m._eventY - (m._endY - m._startY), m.dx = u - m.x, m.dy = k - m.y, "y" !== m.restrictDragToAxis && (m.x = u), "x" !== m.restrictDragToAxis && (m.y = k), O(e, w, m, "drag"), u = 0; u < x.length; u += 1)
                                if (k = x[u], B = w.layer.groups[k], m.groups && B)
                ...
                f && (f[y] || X.mouseEvents[y] && (y = X.mouseEvents[y]), f._event && f.intersects && (n.lastIntersected = f, !(f.mouseover || f.mouseout || f.cursors) || n.drag.dragging || f._hovered || f._fired || (f._fired = !0, f._hovered = !0, O(d, n, f, "mouseover")), f._fired || (f._fired = !0, t.type = null, O(d, n, f, y)), !f.draggable || f.disableEvents || "mousedown" !== y && "touchstart" !== y || (n.drag.layer = f)));
    ...
    g.fn.draw = function c(a) {
        ...
        if (X.drawings[e.type] && "function" !== e.type) this[X.drawings[e.type]](a);
            ...
            for (b = 0; b < this.length; b += 1)
                if (g(this[b]), f = K(this[b])) e = new J(a), N(this[b], e, a, c), e.visible && e.fn && e.fn.call(this[b], f, e); return this
    };
    g.fn.clearCanvas = function a(b) {
        var f, e, h = new J(b);
        for (f = 0; f < this.length; f += 1)
            if (e = K(this[f])) null === h.width || null === h.height ? (e.save(), e.setTransform(1, 0, 0, 1, 0, 0), e.clearRect(0, 0, this[f].width, this[f].height), e.restore()) : (N(this[f], h, b, a), Q(this[f],
    ...
    g.fn.restoreCanvas = function f(e) {
        ...
        for (h = 0; h < this.length; h += 1)
            if (g = K(this[h]))
                for (t = H(this[h]), n = new J(e), N(this[h], n, e, f), y = 0; y < n.count; y += 1) {
                    var E = g,
                        w = t;
    ...
    g.fn.rotateCanvas = function e(h) {
        ...
        for (g = 0; g < this.length; g += 1)
            if (n = K(this[g])) y = H(this[g]), t = new J(h), N(this[g], t, h, e), t.autosave && fa(n, y), za(n, t, y.transforms);
        return this
    };
    g.fn.scaleCanvas = function h(g) {
        var n, t, y, E;
        for (n = 0; n < this.length; n += 1)
            if (t = K(this[n])) E = H(this[n]), y = new J(g), N(this[n], y, g, h), y.autosave && fa(t, E), Aa(t, y, E.transforms);
        return this
    };
    g.fn.translateCanvas = function M(g) {
        ...
        for (t = 0; t < this.length; t +=
            1)
            if (y = K(this[t])) w = H(this[t]), E = new J(g), N(this[t], E, g, M), E.autosave && fa(y, w), Ba(y, E, w.transforms);
        return this
    };
    g.fn.drawRect = function n(g) {
        var y, E, w, C, u, m, k, x, B;
        for (y = 0; y < this.length; y += 1)
            if (E = K(this[y])) w = new J(g), N(this[y], w, g, n), w.visible && (Q(this[y], E, w, w.width, w.height), S(this[y], E, w), E.beginPath(), w.width && w.height && (C = w.x - w.width / 2, u = w.y - w.height / 2, (x = bb(w.cornerRadius)) ? (m = w.x + w.width / 2, k = w.y + w.height / 2, 0 > w.width && (B = C, C = m, m = B), 0 > w.height && (B = u, u = k, k = B), 0 > m - C - 2 * x && (x = (m - C) / 2), 0 > k - u - 2 * x &&
    ...
    g.fn.drawArc = function t(g) {
        var E, w, C;
        for (E = 0; E < this.length; E += 1)
            if (w = K(this[E])) C = new J(g), N(this[E], C, g, t), C.visible && (Q(this[E], w, C, 2 * C.radius), S(this[E], w, C), w.beginPath(), Ka(this[E], w, C, C), T(this[E], w, C), W(this[E],
                w, C));
        return this
    };
    ...
    g.fn.drawSlice = function w(C) {
        ...
        for (u = 0; u < this.length; u += 1)
            if (g(this[u]), m = K(this[u])) k = new J(C), N(this[u],
    ...
    g.fn.drawLine = function C(g) {
        ...
        for (m = 0; m < this.length; m += 1)
            if (k = K(this[m])) x = new J(g), N(this[m], x,
    ...
    g.fn.drawQuadratic = function u(g) {
        ...
        for (k = 0; k < this.length; k += 1)
            if (x = K(this[k])) B = new J(g), N(this[k], B, g, u), B.visible && (Q(this[k], x, B), S(this[k], x, B), x.beginPath(), Na(this[k], x, B, B), T(this[k], x, B), W(this[k], x, B));
        return this
    };
    g.fn.drawBezier = function m(g) {
        var x, B, v;
        for (x = 0; x < this.length; x += 1)
            if (B = K(this[x])) v = new J(g), N(this[x], v, g, m), v.visible && (Q(this[x], B, v), S(this[x],
    ...
    g.fn.drawVector = function k(g) {
        var B, v, z;
        for (B = 0; B < this.length; B += 1)
            if (v = K(this[B])) z = new J(g), N(this[B], z, g, k), z.visible && (Q(this[B], v, z), S(this[B], v, z), v.beginPath(), Ra(this[B], v, z, z), T(this[B], v, z), W(this[B], v, z));
        return this
    };
    g.fn.drawPath = function x(g) {
        ...
        for (v = 0; v < this.length; v += 1)
            if (z = K(this[v]))
                if (p = new J(g), N(this[v], p, g, x), p.visible) {
                    Q(this[v], z, p);
                    S(this[v], z, p);
                    z.beginPath();
                    for (l = 1;;)
                        if (A = p["p" +
                                l], void 0 !== A) A = new J(A), "line" === A.type ? Ma(this[v], z, p, A) : "quadratic" === A.type ? Na(this[v], z, p, A) : "bezier" === A.type ? Oa(this[v], z, p, A) : "vector" === A.type ? Ra(this[v], z, p, A) : "arc" === A.type && Ka(this[v], z, p, A), l += 1;
                        else break;
                    T(this[v], z, p);
                    W(this[v], z, p)
                }
    ...
    g.fn.drawText = function B(v) {
        ...
        for (z = 0; z < this.length; z += 1)
            if (g(this[z]), p = K(this[z]))
                if (l = new J(v), A = N(this[z], l, v, B), l.visible) {
                    ...
                    if (l.radius)
                        for (G = ba(l.fontSize), null === l.letterSpacing && (l.letterSpacing = G / 500), r = 0; r < D.length; r += 1) {
                            p.save();
                            p.translate(l.x, l.y);
                            A = D[r];
                            R = A.length;
                            ...
                            for (r = 0; r < D.length; r += 1) A = D[r], R = l.y + r * l.height / D.length - (D.length - 1) * l.height / D.length / 2, p.shadowColor = l.shadowColor, p.fillText(A, G, R), "transparent" !== l.fillStyle && (p.shadowColor = "transparent"), 0 !== l.strokeWidth && p.strokeText(A, G, R);
                    R = 0;
    ...
    g.fn.drawImage = function v(z) {
        ...
        for (A = 0; A < this.length; A += 1)
            if (l = this[A], D = K(this[A])) r = H(this[A]),
